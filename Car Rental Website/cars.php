...
/**
 * NOTE:
 * - Shared helpers (h() and resolve_image_url()) are defined in includes/helpers.php and
 *   loaded by config.php, so do NOT redefine them here to avoid redeclare errors.
 */
...
<section class="search-section container" id="car-search-section" style="padding: 30px 0 25px;">
    ...
    <form id="cars-filter-form" method="get" action="cars.php" style="display:flex;gap:14px;align-items:flex-end;justify-content:center;margin-bottom:18px;flex-wrap:wrap;">
        ...
        <div style="display:flex;gap:8px;align-items:center;">
            ...
            <a href="cars.php" class="auth-btn" style="background:#888;padding:10px 16px;text-decoration:none;color:#fff;border-radius:8px;">Reset</a>
        </div>
    </form>
                ...
                <?php foreach ($cars as $car): ?>
                    <div class="rental-box car-item" data-name="<?php echo h($car['name']); ?>" data-car-id="<?php echo h((string)$car['id']); ?>">
                        ...
                        <?php if (!empty($car['description'])): ?>
                            <p style="color:#666;font-size:0.95rem;margin-top:6px;"><?php echo h($car['description']); ?></p>
                        <?php endif; ?>
                        <div class="price-btn">
